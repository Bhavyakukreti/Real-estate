          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            <div className="flex items-center gap-x-4 mb-8 ">
              ...
              <div>
                ...
                <Link className="text-violet-700 text-sm " to="">View Listings</Link>
              </div>
            </div>
            <form className="flex flex-col gap-y-4">
              ...
              <textarea className="border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400" placeholder="Message*" defaultValue="Hello, I am interested in [Modern apartment]" />
